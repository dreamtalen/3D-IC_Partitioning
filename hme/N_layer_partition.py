...
def Nlayer_partition(module_wire_dict, wire_module_dict, module_list, wire_list, module_area_dict, wire_weight_dict, N, factor):
    ...
    print 'low and high border', low_border, high_border
    print 'module number', len(module_list)
    print module_list
    ...
    seed_module = 'hme_top_Ref_Mem_ref_8R_32_reg_1948_'
    print seed_module
    ...
    for module in module_list:
        ...
        # print 'INITIAL cost', module, module_list.index(module)
        ...
        for module in module_sorted:
            ...
            if module not in locked_list and N_layer_area_constraint(module, layer_area_list, low_border, high_border, module_layer_dict[module], opti_layer, module_area_dict[module]) and module_gain_dict[module] > 0:
                ...
                for connected_module in connected_module_list:
                    ...
                    # print 'UPDATE gain', connected_module, connected_module_list.index(connected_module), len(connected_module_list)
                break
            end_iter = 1
...
def wire_cost(wire, wire_weight, wire_module_list, module_layer_dict):
    ...
    # max_layer = 0
    # min_layer = 9999
    # for m in wire_module_dict:
    #     try:
    #         this_layer = module_layer_dict[m]
    #     except:
    #         this_layer = 0
    #     if this_layer > max_layer:
    #         max_layer = this_layer
    #     if this_layer < min_layer:
    #         min_layer = this_layer
    # if max_layer-min_layer>0:
    #     return wire_weight*(max_layer-min_layer)
    # else:
    #     return 0
...
if __name__ == '__main__':
    ...
    max_module_num = 10000000
    factor = 0.5
    N = 2
    top_module_name = 'hme_top'
    ...
    # for i in range(6):
    factor = 0.7
    print sum(wire_weight_dict[w] for w in wire_list)
